...
![](assets/behold.png)
- [Formation des équipes](#formation-des-equipes)
- [Présentation du cours](#presentation-du-cours)
- [Format du cours](#format-du-cours)
- [Planification](#planification)
- [Introduction à la vidéo](#introduction-a-la-video)
- [Atelier et introduction au TP1](#atelier-et-introduction-au-tp1)
- [Introduction à la scénarisation](#introduction-a-la-scenarisation)
- [Atelier et introduction au TP2](#atelier-et-introduction-au-tp2)
...
[Partie 1](./TP1-partie1.md)
[Partie 2](./TP1-partie2.md)
[Partie 3](./TP1-partie3.md)
...
Une fois les bases maîtrisées, nous vous proposons de vous exprimer par un projet qui fait le pont avec les installations et expériences interactives.
...
Le projet de feuille de suivi est un outil inspiré des feuilles de personnages de jeux de rôles. Son objectif est de fournir un cadre d'inventaire de projets et d'auto-évaluation pour faire le suivi de ses compétences. C'est donc un outil pour apprendre à se connaître et mettre en commun ses projets. 

Le projet est hébergé sur GitHub et nécessite un compte pour l'utiliser. Une vidéo tutorielle suivra sous peu. Pour l'instant, répondez au formulaire suivant si vous désirez l'utiliser. -->
