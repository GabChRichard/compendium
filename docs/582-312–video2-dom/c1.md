...
- [Différence entre cinéma et vidéo](#difference-entre-cinema-et-video)
- [Caractéristiques essentielles de la vidéo](#caracteristiques-essentielles-de-la-video)
...
- [La résolution](#la-resolution)
- [La fréquence d’image](#la-frequence-dimage) 
...
![cadavre-exquis](./assets/c1/cadavre-exquis.jpg)
...
Pour ce faire nous allons utilisé une version en ligne du jeu : [cadavrexquis.fr](https://www.cadavrexquis.fr/)
