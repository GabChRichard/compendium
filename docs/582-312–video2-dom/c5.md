...
[Dossier de remise](https://cmontmorency365-my.sharepoint.com/:f:/g/personal/dominic_roberts_cmontmorency_qc_ca/IgBFpYKjdhtZTIJK2pteFEjBAcKB4ehYI0efr5KGVHLwD1E?e=zg9miQ){ .md-button }
...
1. Espace colorimétrique de la timeline -> DaVinci WG/Intermediate

2. Espace colorimétrique de destination -> Rec.709 Gamma 2.2

Le but ici est d'avoir un espace colorimétrique plus gros pour travailler, avant de revenir dans un espace colorimétrique standard pour l'exportation. -->
...
>[Capsules Colo Davinci](./da_vinci_colorisation.md)
