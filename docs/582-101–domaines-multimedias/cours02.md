...
Avant d'aménager votre poste, rencontrez les techniciens en travaux pratiques (TTP) responsables du matériel de l'agence : procédure de réservation de local et de matériel, règles de l'atelier.
...
Comme dans toute agence, votre poste de travail doit être bien équipé. Voici les composantes principales :
...
- **Cache** : petite mémoire ultra rapide intégrée au CPU
...
- Capacité recommandée : au moins 8 Go, idéalement 16 Go (un serveur peut avoir 128 Go)
...
**Carte mère (Motherboard)** : plateforme centrale qui permet à toutes les composantes de communiquer. Une bonne carte mère offre plus d'emplacements RAM, un meilleur chipset et davantage de connecteurs de stockage.

**Carte graphique (GPU)** : responsable de l'affichage des images. Possède des centaines/milliers de cœurs simples optimisés pour le calcul en parallèle. Cruciale pour le gaming, le montage vidéo, la modélisation 3D et l'intelligence artificielle.

## Exercice

Pour chacune des composantes de votre poste, identifiez :

- Le concept (qu'est-ce que c'est et à quoi ça sert?)
- Les paramètres principaux
- Les grandes marques
- Le prix d'entrée de gamme et haut de gamme

## Les logiciels d'un ordinateur

Pour qu'un ordinateur fonctionne, il a besoin de logiciels. Trois grandes catégories :

- **Système d'exploitation** : gère les composantes, les processus, les fichiers et l'interaction avec l'utilisateur. Les plus connus : Windows, MacOS, Linux, Android, iOS.
- **Pilotes** : petits programmes qui permettent au système d'exploitation de communiquer avec un périphérique matériel. Chaque pièce a besoin de son pilote.
- **Applications** : programmes utilisés pour accomplir des tâches précises (traitement de texte, navigateur, jeux vidéo, logiciels de montage, etc.)

## Navigation et gestion de fichiers

Compétences essentielles pour organiser votre travail à l'agence :
...
Pour un formatage rapide dans Windows : Ce PC → clic droit sur le disque → Formater. Un assistant permet de choisir le format et le volume des partitions.

## Atelier — Aménagement du poste de travail

Réservation de matériel avec les TTP, mise en place physique du poste, formatage d'une clé USB ou d'un disque externe.

## Préparation pour la semaine prochaine

La semaine prochaine : branchements, réseaux et introduction à l'IA générative. Apportez votre disque dur externe, votre clé USB et votre carte SD.
